# Facial-Emotion-Classifier-using-OpenCV-and-Deepface
...
## Usage
### Initial steps:
- Git clone this repository Run: `git clone https://github.com/arunrajece/Face-Emotions-Classifier.git`
- Run: `cd Face-Emotions-Classifier`
